...
template <> constexpr inline auto ServerManager::qt_create_metaobjectdata<qt_meta_tag_ZN13ServerManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'newClientConnectionReceived'
...
void ServerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ServerManager::*)(QTcpSocket * )>(_a, &ServerManager::newClientConnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerManager::*)(QTcpSocket * )>(_a, &ServerManager::clientDisconnected, 1))
            return;
    }
}
